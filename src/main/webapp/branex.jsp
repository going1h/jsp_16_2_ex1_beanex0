<%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR"%>
    <jsp:useBean id="student1" class="com.javaex.www.Student" scope="page"></jsp:useBean>
    <jsp:useBean id="student2" class="com.javaex.www.Student" scope="page"></jsp:useBean>
<!DOCTYPE html>
<html>
<head>
<meta charset="EUC-KR">
...
<body>
	...
	<jsp:setProperty property="age" name="student1" value="11"/>
